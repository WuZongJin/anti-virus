...
//new prototype funtion added to MyDirectX.h file
...
void Sprite_Transform_Draw(LPDIRECT3DTEXTURE9 image, int x, int y, int width, int heught, int frame = 0, int columns = 1, float rotation = 0.0f, float scaling = 1.0f, D3DCOLOR color = D3DCOLOR_XRGB(255, 255, 255));
